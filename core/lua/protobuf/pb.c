...
lpb_DefFlags cast_to_enum(int i){
    return (lpb_DefFlags)i;
}
...
static void lpb_pushtypetable(lua_State *L, lpb_State *LS, const pb_Type *t) {
    ...
    case LPB_COPYDEF:
        lpb_setdeffields(L, LS, t, cast_to_enum(USE_FIELD|USE_REPEAT|USE_MESSAGE));
        break;
    case LPB_METADEF:
        lpb_setdeffields(L, LS, t, cast_to_enum(USE_REPEAT|USE_MESSAGE));
        lpb_pushdefmeta(L, LS, t);
        lua_setmetatable(L, -2);
        break;
    default:
